...
<?php
require ("jcal_config/config_inc.php");
...
<!-- REPLACE WITH YOUR OWN HEADER IF YOU LIKE -->
  ...
  $dayone = date("N",mktime(1,1,1,$month,$today,$year));
  $numdays = date("t",mktime(1,1,1,$month,$today,$year));
  //$alldays = array('Вс','Пн','Вт','Ср','Чт','Пт','Сб');
  $alldays = array('1' => 'Пн','2' => 'Вт','3' => 'Ср','4' => 'Чт','5' => 'Пт','6' => 'Сб','7' => 'Вс');
  $next_year = $year + 1;
  $last_year = $year - 1;
  if ($today > $numdays) { $today--; }
  
  $day_count = date("N", time());
  $dayone = $dayone - 1;
  ...
  //echo $arr_month[$month-1], $arr_day[$day_count];
  ...
  echo '<table>
          <tr>
            <td valign=\"middle\" align=\"center\">
              <table>
                <tr>
                  <td><b>'.$arr_month[$month-1].', '.$arr_day[$day_count].', '.$today.', '.$year.'</b></td>
                </tr>
              </table>
            </td>
            <td valign=\"middle\" align=\"center\">
  ...
  foreach($alldays as $value) {
    echo "<td class=\"cellbg\" valign=\"middle\" align=\"center\" width=\"10%\"><b>$value</b></td>\n";
  }
  echo "</tr>\n<tr>\n";
  ...
  //еженедельный показ
  //echo "<table border=\"1\" cellpadding=\"2\" cellspacing=\"1\" bgcolor=\"black\" width=\"250\">\n<tr>\n";
  //echo "<td valign=\"middle\" align=\"center\" class=\"cellbg\"><font class=\"regheading\"><b>Неделя | Подробнее</b></font></td></tr>\n";
  ...
  //  			$this_days_title = htmlspecialchars($this_days_title);
  //  		}
  //  	}
    //echo "<tr onMouseOver=\"this.className='cellover'\"; onMouseOut=\"this.className='cellbg'\" class=\"cellbg\" height=\"30\">
      //<td valign=\"top\" onClick=\"window.location='" .$_SERVER['PHP_SELF']. "?year=$current_year&today=$current_day&month=$current_month';\"><a href=\"".$_SERVER['PHP_SELF']."?year=$current_year&today=$current_day&month=$current_month\" class=\"normal\">$dayname - $current_day</a><br>\n";
  ...
  //echo "<center><a href=\"".$_SERVER['PHP_SELF']."\" class=\"normal\">Сегодня</a></center>";
