...
<!-- REPLACE WITH YOUR OWN HEADER IF YOU LIKE -->
          ...
          <tr>
            ...
            <div class='calendar-item'>
              <table border=\"0\" cellpadding=\"0\" cellspacing=\"1\" width=\"611\" bgcolor=\"black\">
                <tr>
                  <td bgcolor=\"white\" valign=\"middle\" align=\"center\"><b>Занятость юриста на ".$arr_month[$month-1].", ".$arr_day[$day_count]." ".$today.", ".$year."</b></td>
                </tr>
              </table>
              </div>
            </td>
  ...
  $eventQuery = "SELECT id, title, event FROM consul WHERE eventdate = '$sql_date';";
